...
export default {
	...
	watch: {
		modelValue( newValue, oldValue ) {
			...
			const editor = this.getEditor();
			if ( editor && newValue !== oldValue && newValue !== this.lastEditorData ) {
	...
	methods: {
		setUpEditorEvents( editor ) {			// Use the leading edge so the first event in the series is emitted immediately.

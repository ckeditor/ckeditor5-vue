...
* `MultiRootEditorWithWatchdogRelaxedConstructor` was renamed to `MultiRootEditorRelaxedConstructor`. It no longer requires the editor class to expose a static `EditorWatchdog`.

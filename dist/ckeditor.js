...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	mounted() {
		this.$_ckeditor_types[this.editor].create(this.$el, this.config).then(editor => {
...
const CKEditor = {
	install(Vue, config) {
		Vue.component(config.componentName || 'ckeditor', _ckeditor_js__WEBPACK_IMPORTED_MODULE_0__["default"]);

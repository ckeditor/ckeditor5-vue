...
This page focuses on describing the usage of the multi-root editor in Vue applications. If you would like to use a different type of editor, you can find more information {@link getting-started/integrations/vuejs-v3 in this guide}.
